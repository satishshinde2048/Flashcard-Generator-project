...
const Error404 = () => {
    return (
        <div className=' flex flex-col justify-center items-center '>
            ...
            <p className='xl:w-1/3 w-[80%] font-normal my-1 text-sm xl:text-base text-blue-200'>The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
            ...
            <Link to='/'
               ...
               font-medium rounded-full px-7 py-2.5 text-center mr-2 mb-10'>
                Go To Home
            </Link>
